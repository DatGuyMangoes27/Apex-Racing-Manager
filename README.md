...
A major pass on the **scheduling, series, and race-weekend loop** — making the calendar run on real venues, supporting multi-race weekends, and enforcing series regulations.
