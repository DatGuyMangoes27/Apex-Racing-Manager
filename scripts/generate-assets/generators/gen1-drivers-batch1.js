/**
 * Generator 1: Drivers Batch 1 (IDs 1-850)
...
const BATCH_START = 0;
const BATCH_END = 850;
const GENERATOR_NAME = 'GEN1-DRIVERS-A';

async function main() {
  console.log(chalk.cyan(`\n${'═'.repeat(60)}`));
  console.log(chalk.cyan.bold(`  ${GENERATOR_NAME}: Drivers Batch 1 (${BATCH_START + 1}-${BATCH_END})`));
  ...
  await saveProfiles(profiles, `drivers-batch1.json`);
